...
class QfDebugMushafSource implements MushafSource {
  ...
  Future<Map<String, String>> _verses(String field, int surah) => _memo(
    '$field:$surah',
    () async {
      final json = await _getJson('quran/verses/$field?chapter_number=$surah');
      return {
        for (final verse in json['verses'] as List)
